<?php get_header(); ?>
    ...
    <div class="parallax-container parallax-biografia valign-wrapper">
      <div class="parallax"><img src="<?php echo get_bloginfo('template_directory');?>/img/00_DSC0111-min2.jpg"></div>
      <h1 class="centrado center-align white-text">ASESORÍA<br>
    ...
    <div class="container margintop75 marginbot50">
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-6 margintop75">
